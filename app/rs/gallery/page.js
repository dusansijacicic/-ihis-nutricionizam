        ...
        <div className="section-white">
          <div className="container">
            ...
            <div className="gal-grid" id="galGrid">
              ...
              {conf8.map((f) => (
                <div className="gal-item" data-group="viii" data-caption="VIII Savetovanje konditorske industrije" data-full={`/assets/img/gallery/8-savetovanje/${f}.jpg`} key={`viii-${f}`}>
                  <Image src={`/assets/img/gallery/8-savetovanje/${f}.jpg`} alt="VIII Savetovanje" fill sizes="(max-width: 600px) 50vw, 260px" style={{ objectFit: 'cover' }} />
                  <div className="gal-overlay"><i className="ion-ios-search-strong"></i></div>
                </div>
              ))}
